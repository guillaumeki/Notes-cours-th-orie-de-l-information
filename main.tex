...
\newcommand{\Zero}{\includegraphics[height=12px]{img/jetons/0}}
\newcommand{\Successor}{\includegraphics[height=12px]{img/jetons/S}}
\newcommand{\Identity}{\includegraphics[height=12px]{img/jetons/I}}
\newcommand{\Left}{\includegraphics[height=12px]{img/jetons/gauche}}
\newcommand{\Right}{\includegraphics[height=12px]{img/jetons/droite}}
\newcommand{\Composition}{\includegraphics[height=12px]{img/jetons/composition}}
\newcommand{\Recurse}{\includegraphics[height=12px]{img/jetons/R}}
\newcommand{\Mu}{\includegraphics[height=12px]{img/jetons/mu}}
...
\end{example}
        ...
        \input{MTF.tex}
        \input{BWT.tex}
        \input{CodageArithmetique.tex}

\section{Théorie algorithmique de l'information}
	
	\input{AlgoInfoTheory}
\section*{Annexe}
\subsection*{Sources}
\begin{itemize}
